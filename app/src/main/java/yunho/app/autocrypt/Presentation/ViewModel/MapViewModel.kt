...
class MapViewModel(
    ...
    fun getCenterInfo(id: Long) = viewModelScope.launch{
        _MapLiveData.postValue(MapDataState.successOne(Repository.getSpecificCenterInfo(id)))
    }
}